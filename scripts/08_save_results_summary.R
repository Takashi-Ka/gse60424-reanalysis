# scripts/08_save_results_summary.R
# ------------------------------------------------------------
# 目的：
#   解析結果の解釈を Results_Summary.md として保存する
# 実行方法：
#   source("scripts/05_save_results_summary.R")
# ------------------------------------------------------------
...
# ファイルに保存
writeLines(summary_text, con = "results/Results_Summary.md")

message("✅ Results_Summary.md を results/ に保存しました。")